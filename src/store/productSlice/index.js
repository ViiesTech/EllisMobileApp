...
export const INITIAL_PRODUCTS = [
  {
    ...
    description:
      'Premium 100% Super 130s Italian Wool. Breathable, crease-resistant, ideal for bespoke tuxedos and business suits.',
    stock: 15,
    material: 'Cotton',
  },
  {
    ...
    description:
      'Tailored fit executive suit crafted with precision padding, pick-stitching, and silk lining.',
    stock: 8,
    material: 'Cotton',
  },
  {
    ...
    description:
      '100% Giza Egyptian Cotton, 140/2 ply thread count. French cuffs and spread collar.',
    stock: 25,
    material: 'Cotton',
  },
  {
    ...
    description:
      'Satin side stripe detail, adjustable side tabs, flat front design.',
    stock: 12,
    material: 'Cotton',
  },
  {
    ...
    image:
      'https://images.unsplash.com/photo-1594938298603-c8148c4dae35?w=500&auto=format&fit=crop&q=80',
    description:
      'Premium light grey suiting cotton fabric with white pinstripes.',
    stock: 20,
    material: 'Cotton',
  },
  {
  ...
  },
  {
    ...
    description:
      'Heavier weight authentic tweed wool fabric for stylish winter coats and structured jackets.',
    stock: 10,
    material: 'Wool',
  },
  {
    ...
    description:
      'Exquisite silk and cotton weave offering a delicate shine and beautiful drape.',
    stock: 15,
    material: 'Silk Blend',
  },
  {
    ...
    image:
      'https://images.unsplash.com/photo-1594938298603-c8148c4dae35?w=500&auto=format&fit=crop&q=80',
    description:
      'Superfine Merino Wool from Biella mills. Ultimate softness, breathability, and thermo-regulation.',
    stock: 8,
